    ...
    <nav>
      ...
      <div class="menu">
        <ul>
          ...
          <li><a href="../mero/product.php">Post</a></li>
          <li>
            <a href="#"><img src="pfp.png" /></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <header>
      <div class="explore">
        <form action="" class="search-bar">
          <input type="search" placeholder="Explore" name="q" />
        ...
        <div class="container">
          <div class="carousel-view">
            ...
            <div id="item-list" class="item-list">
              <a href="#"><img id="item" class="item" src="pfp.png" /></a>
              <a href="#"><img id="item" class="item" src="pfp.png" /></a>
              <a href="#"><img id="item" class="item" src="pfp.png" /></a>
              <a href="#"><img id="item" class="item" src="pfp.png" /></a>
              <a href="#"><img id="item" class="item" src="pfp.png" /></a>
...
<div class="container_product" ">
    <div class="item_product">
      ...
      <p>$20.00</p>
      <button><a href="bidui.html">Bid item</a></button>
    </div>
    <div class="item_product">
